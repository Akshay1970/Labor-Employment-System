				...
				<div class="container-fluid">
					<div class="panel">
								<div class="panel-heading">
									<?php echo $done; ?>
									<h3 class="panel-title"><label>Your all posted jobs</label></h3>
								</div>
								<div class="panel-body no-padding">
									<table class="table">
										...
										<tbody>
											<?php
												$count=0;
												if ($sql=mysqli_query($con,"SELECT * FROM jobs WHERE phone ='$phone'")) {
												...
												<td><a href="delete-job?id=<?php echo $row['id']; ?>" type="button" class="btn btn-danger"><i class="fa fa-trash-o"></i> </a></td>
											</tr>
														<?php
													}
													}
