<?php
	...
	// if (!isset($_SESSION['typea']=="contractor")) {
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							...
							<p class="panel-subtitle"><?php echo $date = date('l d F Y h:i:s A');; ?></p>
						</div>
							...
							<div class="row">
									...
									<div class="metric">
										...
										<p>
											<span class="number">
												<?php
													include 'config.php';
													if ($r=mysqli_query($con,"SELECT * FROM jobs WHERE phone ='$phone'")) {
									...
									<div class="metric">
										...
										<p>
											<span class="number"><?php
													include 'config.php';
													if ($r=mysqli_query($con,"SELECT * FROM apply WHERE host_phone ='$phone'")) {
														echo $rows = mysqli_num_rows($r);
													}
													?></span>
								...
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<span class="number">0</span>
											<span class="title">Pending Task</span>
										</p>
									</div>
								</div>
							</div>
