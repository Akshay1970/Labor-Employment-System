				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Labour</h3>
							...
							<div class="row">
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											...
											<span class="title">Task Pending</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
								...
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<span class="number">0</span>
											<span class="title">Accepted Request</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
						...
						<!-- <div class="col-md-5">
							...
							<div class="panel panel-scrolling">
								...
								ul class="list-unstyled activity-list">
										<li>
											<img src="demo/assets/img/user1.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Michael</a> has achieved 80% of his completed tasks <span class="timestamp">20 minutes ago</span></p>
										</li>
										<li>
											<img src="demo/assets/img/user2.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Daniel</a> has been added as a team member to project <a href="#">System Update</a> <span class="timestamp">Yesterday</span></p>
										</li>
										<li>
											<img src="demo/assets/img/user3.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Martha</a> created a new heatmap view <a href="#">Landing Page</a> <span class="timestamp">2 days ago</span></p>
										</li>
										<li>
											<img src="demo/assets/img/user4.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Jane</a> has completed all of the tasks <span class="timestamp">2 days ago</span></p>
										</li>
										<li>
											<img src="demo/assets/img/user5.png" alt="Avatar" class="img-circle pull-left avatar">
