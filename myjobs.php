<?php
	...
	if (isset($_GET['s'])) {
		 $done= '<div class="alert alert-danger alert-dismissible" role="alert">
										<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
										<i class="fa fa-check-circle"></i> Your job have been deleted succesfully created
									</div>';
	}
	?>
<!doctype html>
				...
				<div class="container-fluid">
					<div class="panel">
								<div class="panel-heading">
									<?php echo $done; ?>
									<h3 class="panel-title"><label>Your all applied jobs</label></h3>
								</div>
								<div class="panel-body no-padding">
									<table class="table">
										...
										<tbody>
											<?php
												$count=0;
												if ($sql=mysqli_query($con,"SELECT * FROM apply WHERE apply_phone ='$phone' ")) {
												...
												<td><a href="d?idx=<?php echo $row['job_id']; ?>" type="button" class="btn btn-danger"><i class="fa fa-trash-o"></i> </a></td>
											</tr>
														<?php
													}
													}
